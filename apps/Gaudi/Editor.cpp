...
namespace Gaudi
{
    ...
    void Editor::SetupVesselSproutingDemo()
    {
        ...
        //    contactInhibitionDensity=7 — tube wall has ~6 neighbors, so inhibition only kicks in
        //    when multiple TipCells cluster together, not during initial tube-wall emigration.
        vessel.AddBehaviour( DigitalTwin::Behaviours::Chemotaxis{ "VEGF", 2.0f, 0.002f, 0.8f, 7.0f } )
            .SetHz( 60.0f )
            .SetRequiredCellType( static_cast<int>( DigitalTwin::CellType::TipCell ) );
        ...
        // 8. Biomechanics: prevents vessel cells from overlapping during sprouting.
        vessel.AddBehaviour( DigitalTwin::BiomechanicsGenerator::JKR()
                                 .SetYoungsModulus( 15.0f )
                                 .SetPoissonRatio( 0.4f )
                                 .SetAdhesionEnergy( 1.0f )
                                 .SetMaxInteractionRadius( 1.5f )
